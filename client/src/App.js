                ...
                <div className="App">
                    ...
                    <Routes>
                        ...
                        <Route element={<components.LoggedUserGuard />}>
                            <Route
                                path="/auth/login"
                                element={<components.Login {...{ isLoading, setIsLoading }} />}
                            />
                            <Route
                                path="/auth/Register"
                                element={<components.Register {...{ isLoading, setIsLoading }} />}
                            />
                        </Route>

                        <Route path="/404" element={<components.ErrorPage />} />
                        <Route element={<components.NoUserGuard />}>
                            <Route
                                path="/auth/profile/:id"
                                element={<components.Profile {...{ isLoading, setIsLoading }} />}
                            />
                            <Route path="/recipe/myRecipes" element={<components.MyRecipes />} />
                            <Route
                                path="/edit/:mealId"
                        ...
                        <Route
                            path="/recipe/browse"
                            element={<components.Browse {...{ isLoading, setIsLoading }} />}
                        />
                        <Route
                            path="/details/:mealId"
                            element={<components.Details {...{ isLoading, setIsLoading }} />}
                        />
                        <Route
                            path="/recipe/macros"
                            element={<components.Macronutrients {...{ isLoading, setIsLoading }} />}
                        />

        ...
        <div className={styles['add-recipe-container']}>
            {isLoading ? (
                ...
                <>
                    ...
                    <div className={styles['add-recipe-secondary']}>
                        ...
                        <div>
                            <article className={styles['recipe-details']}>
                                ...
                                <p className={styles['recipe-add']}>
                                    ...
                                    предвид, че форматирането на текста се запазва, така че, ако желаете
                                    можете да въвеждате продуктите един под друг.
                                </p>
                                {errorMessage !== '' && (
